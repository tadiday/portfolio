...
export default function Projects() {
  ...
  return <section id="projects" className="relative z-30 min-h-screen overflow-hidden bg-[#08090a] px-4 pb-8 pt-[calc(var(--home-header-height)+32px)] text-[#e8e9e9] sm:px-6 lg:px-8">
