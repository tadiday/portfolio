  ...
  return (
    <div className="overflow-x-auto pb-1">
      <div className="min-w-[685px] w-full">
        <div
          className="mb-2 grid h-3 gap-[3px] font-mono text-[8px] uppercase text-[var(--text-muted)]"
              ...
              {week.days.map((day) => {
                ...
                return (
                  <span
                    ...
                    aria-label={label}
                    title={label}
                    className="aspect-square w-full rounded-[2px] transition-[filter,outline-color] duration-150 hover:brightness-125 hover:outline hover:outline-1 hover:outline-[var(--text-primary)]"
                    style={{
                      backgroundColor: levelStyles[day.level],
                      gridRowStart:
